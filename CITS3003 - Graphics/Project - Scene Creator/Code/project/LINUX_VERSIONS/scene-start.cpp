...
void init(void) {
    ...
    char vertexShader[200];
    char fragmentShader[200];
    sprintf(vertexShader, "Part%cShaders/vShader%c.glsl", ACTIVE, ACTIVE);
    sprintf(fragmentShader, "Part%cShaders/fShader%c.glsl", ACTIVE, ACTIVE);
