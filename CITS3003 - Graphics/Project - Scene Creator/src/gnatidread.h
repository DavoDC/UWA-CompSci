...
texture* loadTextureNum(int num) {
    ...
    // To prevent the issues below:
    // - warning: ‘%s’ directive writing up to 255 bytes 
    // into a region of size 220
    // - note: ‘sprintf’ output between 14 and 279 bytes 
    // into a destination of size 220
    // fileName size increased from 220 to 300
    char fileName[300];
...
aiMesh* loadMesh(int meshNumber) {
    ...
    // To prevent the issues below:
    // - warning: ‘/model’ directive writing 6 bytes
    // into a region of size between 1 and 256
    // - note: ‘sprintf’ output between 10 and 275 bytes
    // into a destination of size 256
    // fileName size increased from 256 to 300
    char filename[300];
...
char textureMenuEntries[numTextures][200] = {
...
// DC - Changed string size to 200
char objectMenuEntries[numMeshes][200] = {
...
// DC - Added array for quick object selection
char numberEntries[30][200] = {
    "1 - Normal Light",
    "2 - Directional Light", "3 - Spotlight",
    "4 - 1st Object", "5 - 2nd Object", "6 - 3rd Object",
    "7 - Object", "8 - Object", "9 - Object",
    "10 - Object", "11 - Object", "12 - Object",
    "13 - Object", "14 - Object", "15 - Object",
...
static void activateTool(int button) {
    ...
    // DC - Replaced "clickPrev" with "prevPos", solving "jumpy" camera issue
