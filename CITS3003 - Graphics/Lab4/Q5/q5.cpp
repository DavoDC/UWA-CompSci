...
init(void) {
    ...
    GLuint program = InitShader("vshader5.glsl", "../fshader.glsl");
    ...
    // Enable depth, Set white background
...
display(void) {
    ...
    // Give multiplied matrices to shader
    glUniformMatrix3fv(rotMatrixP, 1, GL_TRUE, (zRot * yRot * xRot));
