...
# Function that inserts all bits of input text in image's pixels 
# and returns a list with the new pixels.
...
# Function that embeds a message in a JPG or a PNG image 
# and return a new PNG image with the embedded message.
