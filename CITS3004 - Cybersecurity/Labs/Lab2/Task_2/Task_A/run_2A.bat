...
echo "********************* Plaintext:"
sed -n 1,1p 2A_plain_orig.txt

echo.

echo "### Command 1 : Trying aes-128-cbc"

echo.
echo "Encrypt:"
@echo on
openssl enc -e -aes-128-cbc -in 2A_plain_orig.txt -out 1-cipher.bin^
    -K bdb264c1400b07679dc4a1553eeb6193 -iv 99b74007b6254e4bd1c6e03631cad15b
@echo off
echo.
echo "1-cipher.bin - part:"
sed -n 1,1p 1-cipher.bin

echo.
echo "Decrypt:"
@echo on
openssl enc -d -aes-128-cbc -in 1-cipher.bin -out 1-output.txt^
    -K bdb264c1400b07679dc4a1553eeb6193 -iv 99b74007b6254e4bd1c6e03631cad15b
@echo off
echo.
echo "1-output.txt - part:"
sed -n 1,1p 1-output.txt
...
echo "#############################################################"
echo "#### Command 2 : Trying -des-ofb "

echo.
echo "Encrypt:"
@echo on
openssl enc -e -des-ofb -in 2A_plain_orig.txt -out 2-cipher.bin^
    -K bdb264c1400b07679dc4a1553eeb6193 -iv 99b74007b6254e4bd1c6e03631cad15b
@echo off
echo.
echo "2-cipher.bin - part:"
sed -n 1,1p 2-cipher.bin

echo.
echo "Decrypt:"
@echo on
openssl enc -d -des-ofb -in 2-cipher.bin -out 2-output.txt^
    -K bdb264c1400b07679dc4a1553eeb6193 -iv 99b74007b6254e4bd1c6e03631cad15b
@echo off
echo.
echo "2-output.txt - part:"
sed -n 1,1p 2-output.txt
...
@REM echo "aes-192-cbc"
@REM openssl enc aes-192-cbc -e -in plain.txt -out cipher.bin -K 00112233445566778899aabbccddeeff -iv 0102030405060708
@REM echo ""

@REM echo "des"
@REM openssl enc des -e -in plain.txt -out cipher.bin -K 00112233445566778899aabbccddeeff -iv 0102030405060708
@REM echo ""
