...
@REM echo "### 1 - ECB    (AES-128)"
@REM openssl enc -e -aes-128-ecb -in 2D_plain20.txt -out ECB-cipher.bin^
@REM     -K bdb264c1400b07679dc4a1553eeb6193 

@REM echo "### 2 -  CBC    (AES-128)"
@REM openssl enc -e -aes-128-cbc -in 2D_plain20.txt -out CBC-cipher.bin^
@REM     -K bdb264c1400b07679dc4a1553eeb6193 -iv 99b74007b6254e4bd1c6e03631cad15b

@REM echo "### 3 - TRYING CFB    (AES-128)"
@REM openssl enc -e -aes-128-cfb -in 2D_plain20.txt -out CFB-cipher.bin^
@REM     -K bdb264c1400b07679dc4a1553eeb6193 -iv 99b74007b6254e4bd1c6e03631cad15b

@REM echo "### 4 - TRYING OFB    (AES-128)"
@REM openssl enc -e -aes-128-ofb -in 2D_plain20.txt -out OFB-cipher.bin^
@REM     -K bdb264c1400b07679dc4a1553eeb6193 -iv 99b74007b6254e4bd1c6e03631cad15b
