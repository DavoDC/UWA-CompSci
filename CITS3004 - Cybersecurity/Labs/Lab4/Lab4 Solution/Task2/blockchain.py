...
class Blockchain:
    ...
    def new_transaction(self, sender, recipient, amount):
        ...
        #------------------------------------------------
        # YOUR CODE GOES HERE
        # append the new transaction to the current_transactions list
        # the new transaction is a dictionary. details in the lab instructions
        #------------------------------------------------
    ...
    def proof_of_work(self, last_block):
        ...
        This is a simple Proof of Work Algorithm:
         ...
         1) Find a number p' such that hash(pp') contains leading 4 zeroes
         2) Where p is the previous proof, and p' is the new proof
         
        :param last_block: <dict> last Block
        :return: <int> proof
        
        Note: you can add the hash of the previous block so PoW cannot be reused.
        """
