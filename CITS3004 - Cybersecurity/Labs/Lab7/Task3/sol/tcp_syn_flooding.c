...
*******************************************/
#define DEST_IP "172.17.0.4"
#define DEST_PORT 22 //80 // Attack the web server
...
int main() {
	...
	while (1) {
		...
		********************************************************/
		...
		ip->iph_sourceip.s_addr = inet_addr("172.17.0.2") + index_sourceip;  //rand(); // Use a random IP address // in_addr is uint32_t
