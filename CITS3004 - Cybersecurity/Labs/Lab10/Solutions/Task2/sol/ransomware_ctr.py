...
def main():
    ...
    startdirs = ['/home/seed/Labs/Lab10/Task2/Testing'] # change this to fit your needs.
...
'''.format(HARDCODED_KEY.decode()))
        ...
        ctr = Counter.new(128)
        crypt = AES.new(decryption_key, AES.MODE_CTR, counter=ctr)
        ...
        ctr = Counter.new(128)
        crypt = AES.new(encryption_key, AES.MODE_CTR, counter=ctr)
