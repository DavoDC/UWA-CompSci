...
public class ManualAgent extends Agent {
    ...
    public ManualAgent(String name) {
        ...
        System.out.println(name + " is a manually controlled agent."
                + "\n To make a move enter the string position followed "
                + "by a spec and then the end position of your move."
                + "\n For example,\nBD2 BD4\n will specify the blue pawn "
                + "in front of the queen should move 2 squares forward.");
    }
    ...
    public Position[] playMove(Board board) {
        ...
        while (true) {
            try {
                ...
                System.out.println(
                        "Invalid move format. Use style \"BA1 RA1\".");
            }
        }
    }
