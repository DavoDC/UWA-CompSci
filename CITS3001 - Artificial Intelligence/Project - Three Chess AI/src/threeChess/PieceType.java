...
/**
 * Enumeration of the different piece types. Values are included for scoring
 * purposes, using the typical values, but 40 for the King. *
 */
public enum PieceType {
    ...
    /**
     * Returns the array of steps that can make legitimate moves. Rooks, Bishops
     * and Queens may iterate one step type in a move. All other pieces may only
     * make one step per move.
     *
     * @return an array or arrays of directions where each inner array is a
     * legitimate step. *
     */
    public Direction[][] getSteps() {
        switch (this) {
            ...
            case ROOK:
                return rookSteps();
            default:
                return kingSteps();//Kings and queens have the same steps, but queens may repeat the one step.
        }
    }

    /**
     * Returns the number of repetitions of a step are allowed. Rooks, Bishops
     * and Queens may iterate one step type in a move. All other pieces may only
     * make one step per move.
     *
    ...
    /**
     * Returns the unicode character corresponding to a black version of this
     * piece. *
     */
    public char getChar() {
        switch (this) {
