 ...
 * For Agents submitted to the CITS3001 tournament, in addition to implementing
 * this interface, agents must use the naming convention: Agent########.java,
 * where the hashes correspond to the authors student number; and each Agent
 * must have a zero parameter constructor (but overloaded constructors are
 * allowed). *
 */
public abstract class Agent implements Runnable {
    ...
    /**
     * 0 argument constructor. This is the constructor that will be used to
     * create the agent in tournaments. It may be (and probably should be)
     * overidden in the implementing class. *
     */
    public Agent() {
    }
