...
public class TSP {
    ...
    /**
     * Reads in filename and sets up all fields.
     */
    ...
    /**
     * Returns the shortest tour found using the NN algorithm, or an error
     * indication.
     */
    public int[] tspnn() {
    ...
    /**
     * Returns the tour derived by applying 2-OPT to cs repeatedly in greedy
     * fashion, or an error indication.
     */
    ...
    /**
     * Checks if cs is a valid tour and returns either its cost or an error
     * indication.
     */
