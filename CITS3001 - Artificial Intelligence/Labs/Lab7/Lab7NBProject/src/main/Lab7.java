...
/**
 * Assesses an intelligent Bohnenspiel player against a range of built-in
 * players; and allows a human to play against the intelligent player.
 */
public class Lab7 implements MouseListener {
    ...
    /**
     * Creates a game against the computer player, with the human playing
     * WEISSE.
     */
    public Lab7() {
        this(Farbe.WEISSE);
    ...
    /**
     * RUN METHOD 1 If you run the main method in the Lab7 class, your player
     * will be tested against the built-in players and a score will be
     * returned.Runs the computer player against a range of built-in players.
     *
     * @param args
     */
    public static void main(String[] args) {
        ...
        // Run all tests many times
        for (int i = 0; i < numTests; i++) {

            // Do test
            int score = doNormalMain();
        ...
        // Average
        double average = scores.stream().mapToInt((x) -> x)
                .average().getAsDouble();
        ...
        // Range
        String range = "Range: ";
        range += "" + Collections.min(scores);
        range += " to ";
        range += "" + Collections.max(scores);
        System.out.println(range + points);
        
        // Percentage
        String perc = ((int) (average * 100.0f) / 200) + "%";
        System.out.println("Percentage: " + perc);
    }

    private static int doNormalMain() {
        BohnenspielPlayer b;
...
//                if (f == Farbe.first()) {
//                    System.out.println(b.getName() + " vs " + opponent.getName());
//                } else {
//                    System.out.println(opponent.getName() + " vs " + b.getName());
//                }
...
//                + 2 * 2 * BuiltinStrategy.values().length * gamesPerOpponent);
//        System.out.println();
