...
/**
 * This is a stripped-down version of the Canvas class from the BlueJ team,
 * retaining only the most fundamental features.
 *
...
public class SimpleCanvas {
    ...
    /**
     * Creates and displays a SimpleCanvas of size 400x400 with the default
     * title "SimpleCanvas" and with white background.
     */
    public SimpleCanvas() {
    ...
    /**
     * Draws a disc on this SimpleCanvas centred at x,y with radius r with
     * colour c.
     */
    ...
    /**
     * Draws a circle on this SimpleCanvas centred at x,y with radius r with
     * colour c.
     */
     ...
     * command, this method can be used to cause a manual repaint.
     */
    public void repaint() {
        canvas.repaint();
    }
    ...
    /**
     * Causes execution to pause for the specified amount of time. This is
     * usually used to produce animations in an easy manner, by repeatedly
     * drawing, pausing, and then redrawing an object.
     */
    public void wait(int millis) {
        try {
            java.util.concurrent.TimeUnit.SECONDS.sleep(millis); // Thread.sleep(millis);
